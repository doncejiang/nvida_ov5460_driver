/*
 * ov5640_tables.h - sensor mode tables for ov5640 HDR sensor.
 *
...
#ifndef __ov5640_I2C_TABLES__
#define __ov5640_I2C_TABLES__

#define ov5640_TABLE_WAIT_MS	0xffff
#define ov5640_TABLE_END	    0xffed

#define ov5640_reg struct reg_8

static ov5640_reg ov5640_start_stream[] = {
	{0x300e, 0x45}, //bit[4:3] to 11 to standby
    {0x3008, 0x02}, //bit[4:3] to 11 to standby
	{ov5640_TABLE_WAIT_MS, 10},
	{ov5640_TABLE_END, 0x00}
};

static ov5640_reg ov5640_stop_stream[] = {
	{0x300e, 0x45 },//& (~(0x18))}, //bit[4:3] to 11 to standby
    {0x3008, 0x42}, //bit[4:3] to 11 to standby
	{ov5640_TABLE_END, 0x00}
};

static ov5640_reg ov5640_mode_common[] = {
    {0x3103, 0x11},
    {0x3008, 0x82},
    {ov5640_TABLE_WAIT_MS, 200},
    //[7]=0 Software reset; [6]=1 Software power down; Default=0x02
	{0x3008, 0x42},
    {ov5640_TABLE_WAIT_MS, 2},
...
static ov5640_reg ov5640_mode_1280x720_60fps[] = {
...
static ov5640_reg ov5640_mode_1920x1080_30fps[] = {
